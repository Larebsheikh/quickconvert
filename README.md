# quickconvert
Flutter app for converting units across length, mass, temperature, volume, area, time, speed, and digital storage ,pure Dart, no backend, no dependencies.
...
Concept from the courseWhere it's used hereStatefulWidget + setState (~11:51:47, ~12:27:11)ConverterScreen — no external state management packageTextField (~10:06:49)Value inputCard / Container + BoxDecoration (~13:34:22, ~10:53:12)ResultCard, UnitDropdownChip widget (~17:14:16)CategoryChipBar — category selectorSplitting & extracting widgets (~09:29:09)Everything under lib/widgets/Row / Padding / layout widgets (~13:58:14, ~10:53:12)Unit selector row with swap button
